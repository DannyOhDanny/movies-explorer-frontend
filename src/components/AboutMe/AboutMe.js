    ...
    <section id="student" className="about-me">
      ...
      <div className="about-me__box-wrapper">
        <article className="about-me__text-wrapper">
          ...
          <div className="about-me__summary">Фронт-энд разработчик, 35 лет.</div>
          <div className="about-me__paragraphs">
            <p className="about-me__paragraph">
              ...
              радиооборудования в формате проектной деятельности в должности бренд-менеджера, а
              затем продакт маркетинг менеджера. В 2022 году решила сменить род деятельности на
              профессию front-end разработчика.
            </p>
            <p className="about-me__paragraph">
